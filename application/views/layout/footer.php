...
<footer class="main-footer">
    ...
    <div class="float-right d-sm-inline">
        <a href="https://github.com/PanduLgg" target="blank"><i class="fab fa-lg fa-github"></i></a>
        <a href="https://www.linkedin.com/in/pandu-linggar-746229197/" target="blank"><i class="fab fa-lg fa-linkedin"></i></a>
        <a href="https://www.instagram.com/pandulg_/" target="blank"><i class="fab fa-lg fa-instagram"></i></a>

    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2022 <a href=" #">STT- Pandu</a>.</strong> All rights reserved.
</footer>
</div>
