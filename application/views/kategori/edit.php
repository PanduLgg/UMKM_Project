            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="float-sm-right">
                        <a href="<?= site_url('/Kategori'); ?>" class="btn btn-warning"><i class=" fa fa-undo"> Back</i></a>
                    </div>
                </div>
                <br>
                <div class="row">
                        ...
                        <div class="col-md-12 col-md-offset-4">
                            <form action="<?= base_url() . 'kategori/update'; ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_kategori" id="nama_kategori" class="form-control" value="<?= $sat->nama_kategori ?>">
                                </div>
                                <div class="form-group">
